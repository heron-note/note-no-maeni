...
const STEPS: HelpStep[] = [
  ...
  { key: 'article-stocker-btn', title: '過去記事ストッカー', description: 'noteからエクスポートした記事データ（zip）を取り込んで、フリーワードや名詞で検索・絞り込みができるよ。気に入った記事をコレクションにまとめて、Kindle出版などに活かすためのAIプロンプトをワンタップで生成できる。プロンプトはコピーして、いつも使っているAIに貼り付けて使ってね！エクスポート手順はアプリ内のリンクから確認できるよ。' },
