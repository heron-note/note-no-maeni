  ...
  useEffect(() => {
    ...
    function renderList() {
      ...
      currentFiltered.forEach((art: any) => {
        ...
        item.innerHTML = `<span class="as-date">${art.date.split(' ')[0]}</span><span style="display:block;word-break:break-all;overflow-wrap:anywhere;font-weight:600;">${art.title}</span>${mark}`
        item.addEventListener('click', () => {
